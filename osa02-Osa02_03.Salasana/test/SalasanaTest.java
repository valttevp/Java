...
public class SalasanaTest {
    ...
    public void ohjelmaKysyyUudelleenKunVaarin() {
        ...
        assertTrue("Ohjelman pitäisi kysellä salasanaa kunnes se saa oikean salasanan.", vikarivi.contains("salasana"));
    }
    ...
    public void ohjelmaLopettaaKyselynKunOikein() {
        ...
        int vaarinVikaIndeksi = out.lastIndexOf("rin");
    ...
    public void lopussaSalaisuus() {
        ...
        int vaarinVikaIndeksi = out.lastIndexOf("rin") + "rin".length();
