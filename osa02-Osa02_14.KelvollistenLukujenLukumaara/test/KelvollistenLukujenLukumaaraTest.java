...
@Points("02-14")
public class KelvollistenLukujenLukumaaraTest {
    ...
    @Test
    public void testi() {
        int[][] syotteet = {{5, 22, -11, -140, -18, 9999, 4}, {1, 9999, 1}, {9999, 0}, {-3, -2, -1, -141, 9999, 3}};
    ...
    private void tarkista(int... luvut) {
        ...
        io.setSysIn(in);
        callMain(KelvollistenLukujenLukumaara.class);
    ...
    private static int otaLukuLopusta(String inputStr) {
        ...
        assertTrue("Tulostuksen pitäisi olla muotoa \"Kelvollisia lukuja yhteensä: 10\". Nyt tulostit: " + inputStr, matcher.find());
